...
export const FactionManager = {
  joinFaction: function (factionName, username) {
    ...
    if (
      GAME_STATE.factionRequests[factionName].size >= foundersRequired &&
  ...
  createFaction: function (factionName) {
    ...
    let nameText = GAME_STATE.gameScene.add
      .text(x, y - 10, factionName.toUpperCase(), {
    ...
    let officersText = GAME_STATE.gameScene.add
      .text(x, y + 10, '', {
        font: '12px Arial',
        fill: '#ffffff',
        align: 'center',
  ...
  showJoinMessage: function (faction, username) {
    const joinMessage = GAME_STATE.gameScene.add
      .text(faction.blob.x, faction.blob.y - faction.blob.radius - 20, username + ' joined!', {
        font: '16px Arial',
        fill: '#ffffff',
        align: 'center',
        stroke: '#000000',
